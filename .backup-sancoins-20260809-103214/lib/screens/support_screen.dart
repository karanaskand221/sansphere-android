  ...
  Future<void> _submitTicket() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Ticket submitted! Our team will reach out via email."), backgroundColor: Colors.green),
      );
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text("We're here to help", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 6),
              const Text("Fill this out and our team will follow up by email.", style: TextStyle(color: Colors.grey)),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: "Your Email", border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(labelText: "Issue Topic", border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
              ...
              TextFormField(
                ...
                maxLines: 5,
                decoration: InputDecoration(labelText: "Describe the issue / suggestion", border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
