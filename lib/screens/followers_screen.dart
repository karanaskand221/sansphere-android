    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (users.isEmpty) {
            return const _FollowersMessage(
...
class _FollowerUserTile extends StatelessWidget {
  final String uid;
  final String name;
...
class _FollowersMessage extends StatelessWidget {
  final IconData icon;
  final String message;

  const _FollowersMessage({required this.icon, required this.message});
